...
void rolodex()
{
    ...
    while (cin >> word) {
        ...
        if (rolodex.isBeforeFirst() || rolodex.currentValue() <= word) {
            ...
            else if (rolodex.currentValue() == word && duplicates && !report) {
                countDuplicate++;
                if (verbose)
                    cerr << "rotateForward\n";
            }
            ...
            else if (rolodex.currentValue() == word && duplicates) {
                countDuplicate++;
                if (verbose)
                    cerr << "rotateForward\n";
            }
            else if (rolodex.isBeforeFirst() || rolodex.currentValue() == word && !duplicates) {
                rolodex.insertAfterCurrent(word);
                countInsert++;
                if (verbose)
                    cerr << "insertBeforeCurrent\n";
